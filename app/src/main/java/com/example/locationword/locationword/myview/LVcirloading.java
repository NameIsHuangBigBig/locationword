...
public class LVcirloading extends View {
    ...
    public LVcirloading(Context context) {
        this(context, null);
    }

    public LVcirloading(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LVcirloading(Context context, AttributeSet attrs, int defStyleAttr) {
