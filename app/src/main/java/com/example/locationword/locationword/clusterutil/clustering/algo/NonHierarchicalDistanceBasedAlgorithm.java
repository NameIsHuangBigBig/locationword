...
package com.example.locationword.locationword.clusterutil.clustering.algo;
...
import com.example.locationword.locationword.clusterutil.projection.Bounds;
...
import com.example.locationword.locationword.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.example.locationword.locationword.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.example.locationword.locationword.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.example.locationword.locationword.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.example.locationword.locationword.clusterutil.clustering.algo
