 ...
 */
package com.example.locationword.locationword.clusterutil.projection;
...
public class SphericalMercatorProjection {
    ...
    public LatLng toLatLng(com.example.locationword.locationword.clusterutil.projection.Point point) {
