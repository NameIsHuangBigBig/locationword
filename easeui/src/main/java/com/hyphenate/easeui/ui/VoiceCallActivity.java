...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        faceImage = (ImageView) findViewById(R.id.swing_card);
        ...
        String arrtarurl = getIntent().getStringExtra("arrtar");
        Log.i("extras","arrtarurl"+arrtarurl);

        if (arrtarurl!=null){
		    if (!arrtarurl.equals("")){
                Glide.with(VoiceCallActivity.this).load(arrtarurl).placeholder(R.drawable.ease_default_avatar).into(faceImage);
            }
		}
